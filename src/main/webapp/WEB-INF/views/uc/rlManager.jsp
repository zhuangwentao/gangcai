...
<title>买卖钢材网maisteel.com-个人中心-资源单管理</title>
				 ...
				 <div class="search">
			    	<div class="col-md-12 col-sm-12">
				    	<div class="col-md-2 col-sm-2"> 
				    		<label>
								<select  id="rlManagerPage-sel-pagesize" class="form-control input-sm input-xsmall input-inline">
...
<!-- 								 <input type="text" class="form-control input-sm input-small  input-inline" style="display: inline;" placeholder="地区" id="classification-serch-key" onkeyup="rlManagerPage.keyEnter(event)"> -->
<!-- 					    </div> -->
					    ...
					    <div class="col-md-2 col-sm-2"> 
								 <input type="text" class="form-control input-sm input-small  input-inline" style="display: inline;" placeholder="大类" id="classification-serch-key" onkeyup="rlManagerPage.keyEnter(event)">
					    </div>
					    <div class="col-md-2 col-sm-2"> 
								 <input type="text" class="form-control input-sm input-small  input-inline" style="display: inline;" placeholder="主营品种" id="mainVarieties-serch-key" onkeyup="rlManagerPage.keyEnter(event)">
					    </div>
					    <div class="col-md-2 col-sm-2"> 
								 <input type="text" class="form-control input-sm input-small  input-inline" style="display: inline;" placeholder="上传时间" id="date-serch-key" maxlength="8" onFocus="WdatePicker({dateFmt: 'yyyy-MM-dd', isShowToday: false, isShowClear: false,width: 240})" onkeyup="rlManagerPage.keyEnter(event)">
					    </div>
					    <div class="col-md-1 col-sm-1" style="text-align: center;"> 
							  <a onclick="rlManagerPage.queryByEnter()" class="btn-search search" type="button">搜索</a>
					    </div>
<!-- 					    <div class="col-md-2 col-sm-2" >  -->
<%-- 							  <a href="${pageContext.request.contextPath}/system/uploadResourceList" class="btn btn-warning" type="button">上传资源单</a> --%>
<!-- 					    </div> -->
				     </div>
			     </div>
				 <!--检索栏结束-->
...
<script src="${pageContext.request.contextPath}/resource/js/uc/rlManager.js"></script>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#rlManagerPage-sel-pagesize").change(function(){
        	rlManagerPage.queryrlManagerPageListForPage(1);
        });
    });
</script>
