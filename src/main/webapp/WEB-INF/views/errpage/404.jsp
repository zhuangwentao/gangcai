...
<title>买卖钢材网maisteel.com-404page</title>
...
img { border:0}
body{background:#fff;color:#333;font-size:12px;font-family:Arial,'å®ä½'}
...
<div class="m404">
<a href="javascript:void(0)" onclick="redirect()" ><img src="${pageContext.request.contextPath}/resource/images/404.png" width="409" height="177" alt="âççå¾æ±æ­ï¼é¡µé¢å·²ç»è¢«å é¤æèæä»¬æä¸¢äºâ¦â¦âè¦ä¸å»é¦é¡µççï¼"></a></div>
</span>
